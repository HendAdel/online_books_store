...
var authorModel = /** @class */ (function () {
    function authorModel() {
    }
    authorModel.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("cannot get the authors ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Unable to create (".concat(a.name, "): ").concat(error_1.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    authorModel.prototype.showById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("cannot get the author ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    authorModel.prototype.updateById = function (a) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    authorModel.prototype.deleteById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("cannot delete the author ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
