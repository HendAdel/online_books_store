...
describe("category endpoints CRUD methods test", function () {
    ...
    it('Should List all categories', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request
    ...
    it('Should return one category', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result, _a, id, name;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, request
                        .get("/categories/ ".concat(category.id))
                        .set('Content-type', 'application/json')];
                case 1:
                    result = _b.sent();
    ...
    it('Should update category by Id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result, _a, id, name;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, request
                        .put("/categories/ ".concat(category.id))
                        .set('Content-type', 'application/json')
                        .send({
    ...
    it('Should delete one category by Id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result, _a, id, name;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, request
                        .delete("/categories/ ".concat(category.id))
                        .set('Content-type', 'application/json')
                        .send({ id: category.id })];
                case 1:
                    result = _b.sent();
